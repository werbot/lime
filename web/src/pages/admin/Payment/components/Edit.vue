  ...
  <div v-else>
    ...
    <Form @submit="onSubmit" v-slot="{ errors }" class="space-y-4">
      <div class="mt-5 flex flex-row">
        <FormSelect name="Status" v-model="drawer.data.transaction.status" :options="data.lists.status" id="status" :error="errors.status" :required="true"
...
import { Skeleton, SvgIcon, FormInput, FormSelect } from "@/components";
